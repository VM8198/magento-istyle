    ...
    \Magento\Framework\Data\Tree\Node $menuTree, $childrenWrapClass, $limit, $colBrakes = []
        ...
        foreach ($children as $child) {
            ...
            if (count($colBrakes) && $colBrakes[$counter]['colbrake']) {
                $html .= '</ul></li><li class="column"><ul class="child-menu-2">';
            }
            }
        ...
        if (count($colBrakes) && $limit) {
            $html = '<li class="column"><ul class="child-menu-3">' . $html . '</ul></li>';
        }
        }
        return $html;
    }
    ...
    \Magento\Framework\Data\Tree\Node $menuTree, $childrenWrapClass, $limit, $colBrakes = []
        ...
        if ($this->dataHelper->allowExtension()) {
            ...
            foreach ($children as $child) {
                ...
                if(is_array($colBrakes) || is_object($colBrakes)){
                if (count($colBrakes) && $colBrakes[$counter]['colbrake']) {
                    $html .= '</ul></li><li><ul class="child-menu-4">';
                }
                }
                $html .= '<li>';
            ...
            if(is_array($colBrakes) || is_object($colBrakes)){
            if (count($colBrakes) && $limit) {
                $html = '<li class="column"><ul class="child-menu-5">' . $html . '</ul></li>';
            }
            }
            return $html;
        } else {
