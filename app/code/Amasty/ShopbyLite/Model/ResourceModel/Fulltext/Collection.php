...
namespace Amasty\ShopbyLite\Model\ResourceModel\Fulltext;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    ...
    /**
     * @var \Amasty\ShopbyLite\Model\Request\Builder
     */
    ...
    public function __construct(
        ...
        \Amasty\ShopbyLite\Model\Request\BuilderFactory $requestBuilderFactory,
    ...
    /**
     * @return \Amasty\ShopbyLite\Model\Request\Builder
     */
    ...
    public function addCategoryFilter(\Magento\Catalog\Model\Category $category)
    {
        ...
        return parent::addCategoryFilter($category); // TODO: Change the autogenerated stub
    }
    ...
    public function addIndexCategoriesFilter(array $categoriesFilter)
    {
        foreach ($categoriesFilter as $conditionType => $values) {
            ...
            $this->requestBuilder->bind(Filter::ATTRIBUTE_CODE_CATEGORY, $values);
        }
        return $this;
    }
